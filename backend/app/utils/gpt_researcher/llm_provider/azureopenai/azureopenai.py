...
class AzureOpenAIProvider:
    ...
    async def get_chat_response_stream(
        self, messages, stream, websocket=None, yield_stream=False
    ):
        async for response in self.yield_stream_response(messages):
            yield response
    ...
    async def yield_stream_response(self, messages):
