...
# async def yield_generate_report(
#     query: str,
#     context,
#     agent_role_prompt: str,
#     report_type: str,
...
#     print(content)
#     try:
#         async for response in create_chat_completion(
#             model=cfg.smart_llm_model,
#             messages=[
#                 {"role": "system", "content": f"{agent_role_prompt}"},
...
async def generate_report_yield(
    query: str,
    context,
    agent_role_prompt: str,
    report_type: str,
    ...
    try:
        async for response in create_chat_completion_yield(
            model=cfg.smart_llm_model,
            messages=[
                {"role": "system", "content": f"{agent_role_prompt}"},
                {"role": "user", "content": content},
