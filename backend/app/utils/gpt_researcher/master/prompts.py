...
def generate_report_prompt(
    ...
    if report_source == ReportSource.Web.value:
        reference_prompt = f"""
            You MUST write all used source urls and documents at the end of the report as references, and make sure to not add duplicated sources, but only one reference for each.
            Every url source should be hyperlinked: [url website](url)
            ...
            eg:
                ...
                This is a sample text. [soure document file name]
